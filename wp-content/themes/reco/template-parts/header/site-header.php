...
<header id="masthead" class="<?php echo esc_attr( $wrapper_classes ); ?> header">
    <nav class="navbar navbar-expand-xl navbar-light nav">
        <div class="container-fluid nav-container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 navigate">
                    <?php
                       echo get_list_primary_menu()
                    ?>
                    <li class="nav-item">
                        <a class="nav-link active nav-item-last navigate-link" aria-current="page" href="#">
                            <svg class="nav-item-last-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                ...
                <div class="btn-group">
                    <a class="btn button-sign-in" href="https://job.reco-vn.com/account/Login" target="_blank">
                        <svg class="button-sign-in-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <a class="btn button-register" href="https://job.reco-vn.com/account/partner/register" target="_blank">
                        <svg class="button-register-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
